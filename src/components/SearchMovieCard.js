        ...
        <div className="absolute z-10 movie-search-card px-4 bg-white shadow">
            {movieList && movieList.length > 0 && 
                movieList.map((movieListResult) => (
                    <a key={movieListResult.id} href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 w-full mt-2">
