    ...
    return(
        <div className='pb-4 mt-20'>
            <div className="trending-banner relative overflow-hidden bg-gray-900 py-24 sm:py-24 banner-overlay text-center">
                <h3 className='mb-4 text-6xl font-bold text-primary-color relative z-50'>Trending Now</h3>
            </div>
            <div className="container mx-auto">
                <h3 className='my-4 text-3xl font-bold text-primary-color relative z-50'>Trending Movies</h3>
